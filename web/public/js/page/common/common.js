...
let MenuTools = {
    menuList: [{
        ...
        bottomContent: '<div class="content">' +
            ...
            '<div class="item bottom-right"><span class="title"><i class="fa fa-spinner fa-spin"></i> 京东 618 每天领红包，最高19618元哟～</span><a class="link-btn" href="https://u.jd.com/JK9b2xd">立即领取</a></div></div>',
