...
echo -e "\n[${BLUE}$(date "${TIME}")${PLAIN}] ----- ➀ 同步最新源码结束 -----\n"

## ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 第 二 区 域 ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
echo -e "\n[${BLUE}$(date "${TIME}")${PLAIN}] ----- ➁ 挂机程序开始 -----\n"
...
echo -e "[${BLUE}$(date "${TIME}")${PLAIN}] ----- ➁ 挂机程序结束 -----\n"

## ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 第 三 区 域 ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
echo -e "\n[${BLUE}$(date "${TIME}")${PLAIN}] ----- ➂ Telegram Bot 开始 -----\n"
...
echo -e "[${BLUE}$(date "${TIME}")${PLAIN}] ----- ➂ Telegram Bot 结束 -----\n"

## ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 第 四 区 域 ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
echo -e "\n[${BLUE}$(date "${TIME}")${PLAIN}] ----- ➃ 控制面板和网页终端开始 -----\n"
if [[ ${ENABLE_WEB_PANEL} == true ]]; then
  ...
  echo -e "\n[${BLUE}$(date "${TIME}")${PLAIN}] 网页终端启动成功 $SUCCESS\n"

  cd web
  npm install >/dev/null 2>&1
  pm2 start ecosystem.config.js
  cd ${WORK_DIR}
  echo -e "\nTips: 如未修改用户名密码，则初始用户名为：useradmin，初始密码为：supermanito"
  echo -e "      请访问 http://<IP>:5678 登陆控制面板并修改配置，第一次登录会自动修改初始密码"
  echo -e "\n[${BLUE}$(date "${TIME}")${PLAIN}] 控制面板启动成功 $SUCCESS\n"
elif [[ ${ENABLE_WEB_PANEL} == false ]]; then
  echo -e "已设置为不自动启动控制面板"
fi
echo -e "\n[${BLUE}$(date "${TIME}")${PLAIN}] ----- ➃ 控制面板和网页终端结束 -----\n"

## ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 第 五 区 域 ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
echo -e "\n[${BLUE}$(date "${TIME}")${PLAIN}] ----- ➄ 预装环境开始 -----\n"
if [[ ${ENABLE_ALL_ENV} == false ]]; then
  echo -e "已设置为不在容器启动时安装环境包\n"
else
  $ContrlCmd env install
fi
echo -e "[${BLUE}$(date "${TIME}")${PLAIN}] ----- ➄ 预装环境结束 -----\n"
...
echo -e "\n[${BLUE}$(date "${TIME}")${PLAIN}] \033[1;32m容器启动成功${PLAIN}\n"
