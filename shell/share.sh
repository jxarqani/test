...
function Help() {
 ...
 ❋ 用于执行脚本的可选参数： 
    ...
    ${BLUE}-c${PLAIN} | ${BLUE}--cookie${PLAIN}        指定账号运行，参数后面需跟账号序号，多个账号用 \",\" 隔开，账号区间用 \"-\" 连接，可以用 \"@\" 表示账号总数
    ${BLUE}-g${PLAIN} | ${BLUE}--grouping${PLAIN}      账号分组运行，参数后面需跟账号序号，多个账号用 \",\" 隔开，账号区间用 \"-\" 连接，组与组之间用 \";\" 隔开，可以用 \"@\" 表示账号总数
